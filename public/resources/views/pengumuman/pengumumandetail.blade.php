...
<section class="ftco-section bg-light">
    <div class="container">
        <div class="row justify-content-center pb-4 gap-5">
            <div class="col-lg-8 col-md-12 col-sm-12 mb-2 mx-auto">
                <div class="heading-section">
                    <h3 style="margin-bottom: -5px;">New Home Sales Picked Up in December</h3>
